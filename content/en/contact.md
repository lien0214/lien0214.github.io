...
<div class="cf-section">
  ...
  <form id="cf-form" class="cf-form" novalidate>
    ...
    <div class="cf-field">
      ...
      <span id="cf-msg-error" class="cf-field-error" style="display:none">Please write a message first.</span>
    </div>
    <button type="button" id="cf-submit" class="cf-btn-google">
      ...
      <span id="cf-btn-label">Sign in with Google &amp; Send</span>
      <span id="cf-btn-spinner" style="display:none">⏳</span>
    </button>
  </form>
...
(function () {
  ...
  function initGSI() {
    tokenClient = google.accounts.oauth2.initTokenClient({
      ...
      callback: function (resp) {
        if (resp.error) { showError(); return; }
  ...
  submitBtn.addEventListener('click', function () {
    ...
    if (!CLIENT_ID || !SCRIPT_URL) { showError(); return; }
