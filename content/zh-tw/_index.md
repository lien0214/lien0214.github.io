...
我是台灣大學資訊工程系的碩士生，同時在兩個研究室進行研究：[MIRLab](http://mirlab.org/)（多媒體資訊檢索實驗室，我在這裡研究台股量化交易策略）和 [MSLab](https://mslab.csie.ntu.edu.tw/)（機器智慧與智能代理系統實驗室，我的論文研究大型語言模型中的知識衝突與記憶問題）。在碩士之前，我在 Shopback 和 Cmoney 累積了約一年半的後端工程師實習經驗，接觸過真實產品、真實流量、以及真實的系統故障。
