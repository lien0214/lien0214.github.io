...
<div class="contact-list">
  ...
  <a href="tel:+886902323591" class="contact-item">
    ...
    <div>
      <div class="contact-item-label">電話</div>
...
<div class="cf-section">
  ...
  <form id="cf-form" class="cf-form" novalidate>
    ...
    <div class="cf-field">
      ...
      <span id="cf-msg-error" class="cf-field-error" style="display:none">請先輸入訊息內容。</span>
    </div>
    <button type="button" id="cf-submit" class="cf-btn-google">
      ...
      <span id="cf-btn-label">用 Google 登入並送出</span>
  ...
  <div id="cf-error" class="cf-notice cf-notice-err" style="display:none">
    發生錯誤，請直接寄信至 <a href="mailto:ted20030214@gmail.com">ted20030214@gmail.com</a>。
  </div>
</div>
