...
<div class="cf-section">
  ...
  <div id="cf-gsi-wrap">
    ...
    <p class="cf-gsi-hint">登入 Google 帳號可自動填入姓名與 Email，或直接在下方手動填寫。</p>
  </div>
  ...
  <form id="cf-form" class="cf-form" novalidate>
    <div class="cf-row">
      <div class="cf-field">
        ...
        <input id="cf-name" name="name" type="text" placeholder="你的名字" autocomplete="name" required>
      </div>
      <div class="cf-field">
